...
gateway = braintree.BraintreeGateway(
  braintree.Configuration(
      ...
      merchant_id="t2wv58r83k32j9b8",
      public_key="dpq4n2r942gxqn53",
      private_key="979121670e27fe7675ca3c32e5992b41"
  )
)
...
def generate_token(request, id, token):
    ...
    return JsonResponse({'clientToken': gateway.lient_token.generate(), 'success':True})
